...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`Restaurant booking engine v3`}</title>

        <meta
          name="description"
          content="Welcome to Restaurant Booking Engine v3 - Streamlining your dining experience with seamless table reservations and efficient menu management."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Restaurant booking engine v3`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Restaurant Booking Engine v3 - Streamlining your dining experience with seamless table reservations and efficient menu management.`}
            </Text>
            <Box
